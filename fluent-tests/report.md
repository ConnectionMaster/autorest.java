# Java Codegen Report
Generated at 2021-06-27T19:20:19.140433
## Success
<details>
...
[INFO] Finished at: 2021-06-27T18:48:39Z
[INFO] ------------------------------------------------------------------------
...
[INFO] Finished at: 2021-06-27T18:55:55Z
[INFO] ------------------------------------------------------------------------
...
INFORMATION (FluentJavaSettings): Option, boolean, sdk-integration : null
INFORMATION (FluentGen): Map code model to client model
INFORMATION (FluentMapper): Add Inner to response types: [AutomationValidationStatus, OnPremiseIotSensor, Setting, SecuritySubAssessment, Device, IoTSecuritySolutionAnalyticsModelList, InformationProtectionPolicy, Pricing, AscLocation, AdaptiveNetworkHardening, SecurityAssessmentMetadata, AdaptiveApplicationControlGroup, SecurityContact, PackageDownloads, PricingList, IoTSecuritySolutionModel, DiscoveredSecuritySolution, SecureScoreControlDefinitionItem, AdaptiveApplicationControlGroups, RegulatoryComplianceStandard, Automation, ScanResults, ComplianceResult, IotAlertType, ServerVulnerabilityAssessmentsList, IotDefenderSettingsModel, IoTSecurityAggregatedAlert, IotRecommendationTypeList, AdvancedThreatProtectionSetting, IotSensorsModel, AllowedConnectionsResource, TopologyResource, IotRecommendationModel, Software, IoTSecurityAggregatedRecommendation, SecurityAssessment, DeviceSecurityGroup, SecuritySolutionsReferenceDataList, WorkspaceSetting, IotAlertModel, RegulatoryComplianceControl, RulesResults, AutoProvisioningSetting, IotDefenderSettingsList, IoTSecuritySolutionAnalyticsModel, Alert, Scan, OnPremiseIotSensorsList, IngestionSetting, IotSitesList, IotSensorsList, Operation, JitNetworkAccessPolicy, RegulatoryComplianceAssessment, IotSitesModel, IngestionSettingToken, ServerVulnerabilityAssessment, JitNetworkAccessRequest, RuleResults, ConnectorSetting, SecuritySolution, AlertsSuppressionRule, ConnectionStrings, Compliance, Scans, IotAlertTypeList, IotRecommendationType, SecureScoreControlDetails, SecurityTask, ScanResult, ExternalSecuritySolution, SecureScoreItem]
