# Java Codegen Report
Generated at 2021-06-11T19:16:33.997300
## Success
<details>
...
INFORMATION (FluentMapper): Add Inner to response types: [Factory, SelfHostedIntegrationRuntimeNode, IntegrationRuntimeMonitoringData, AddDataFlowToDebugSessionResponse, IntegrationRuntimeResource, PrivateLinkResourcesWrapper, Operation, DatasetResource, SsisObjectMetadataListResponse, DataFlowDebugCommandResponse, ExposureControlBatchResponse, IntegrationRuntimeStatusResponse, DataFlowDebugSessionInfo, TriggerSubscriptionOperationStatus, TriggerResource, ManagedPrivateEndpointResource, ActivityRunsQueryResponse, LinkedServiceResource, IntegrationRuntimeNodeIpAddress, ManagedVirtualNetworkResource, IntegrationRuntimeAuthKeys, TriggerRunsQueryResponse, IntegrationRuntimeConnectionInfo, DataFlowResource, PrivateEndpointConnectionResource, ExposureControlResponse, PipelineRunsQueryResponse, SsisObjectMetadataStatusResponse, TriggerQueryResponse, PipelineResource, PipelineRun, GitHubAccessTokenResponse, AccessPolicyResponse, CreateRunResponse, CreateDataFlowDebugSessionResponse]
...
[INFO] Finished at: 2021-06-11T18:47:18Z
[INFO] ------------------------------------------------------------------------
...
[INFO] Finished at: 2021-06-11T18:54:04Z
[INFO] ------------------------------------------------------------------------
...
INFORMATION (FluentJavaSettings): Option, boolean, sdk-integration : null
INFORMATION (FluentGen): Map code model to client model
INFORMATION (FluentMapper): Add Inner to response types: [IotAlert, Pricing, IotRecommendationTypeList, Compliance, Software, RulesResults, IotRecommendationType, Operation, AdaptiveApplicationControlGroups, SecureScoreItem, JitNetworkAccessRequest, SecuritySubAssessment, ScanResults, ServerVulnerabilityAssessment, IotSensorsModel, OnPremiseIotSensorsList, ConnectorSetting, Alert, SecuritySolution, WorkspaceSetting, ExternalSecuritySolution, RegulatoryComplianceStandard, SecurityAssessment, OnPremiseIotSensor, ServerVulnerabilityAssessmentsList, SecureScoreControlDetails, DiscoveredSecuritySolution, ScanResult, AdaptiveApplicationControlGroup, InformationProtectionPolicy, AutomationValidationStatus, IoTSecuritySolutionAnalyticsModel, IotSitesList, IoTSecurityAggregatedRecommendation, AscLocation, ConnectionStrings, RuleResults, IotDefenderSettingsModel, Setting, PackageDownloads, IotDefenderSettingsList, Automation, IotRecommendationModel, IotAlertModel, AlertsSuppressionRule, IngestionSettingToken, DeviceSecurityGroup, IoTSecurityAggregatedAlert, IngestionSetting, AutoProvisioningSetting, Scans, RegulatoryComplianceAssessment, IotAlertType, Scan, SecureScoreControlDefinitionItem, SecuritySolutionsReferenceDataList, IotAlertTypeList, JitNetworkAccessPolicy, AllowedConnectionsResource, TopologyResource, IoTSecuritySolutionAnalyticsModelList, IoTSecuritySolutionModel, IotSensorsList, IotSitesModel, SecurityContact, SecurityAssessmentMetadata, RegulatoryComplianceControl, AdaptiveNetworkHardening, AdvancedThreatProtectionSetting, SecurityTask, PricingList, IotRecommendation, ComplianceResult, Device]
...
FATAL: [object Object]
(node:24039) UnhandledPromiseRejectionWarning: Error: Plugin model-validator reported failure.
...
(node:24039) UnhandledPromiseRejectionWarning: Unhandled promise rejection. This error originated either by throwing inside of an async function without a catch block, or by rejecting a promise which was not handled with .catch(). To terminate the node process on unhandled promise rejection, use the CLI flag `--unhandled-rejections=strict` (see https://nodejs.org/api/cli.html#cli_unhandled_rejections_mode). (rejection id: 60)
(node:24039) [DEP0018] DeprecationWarning: Unhandled promise rejections are deprecated. In the future, promise rejections that are not handled will terminate the Node.js process with a non-zero exit code.
...
[INFO] Finished at: 2021-06-11T19:01:59Z
[INFO] ------------------------------------------------------------------------
