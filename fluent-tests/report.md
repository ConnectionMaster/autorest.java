# Java Codegen Report
Generated at 2021-02-16T19:33:59.167020
## Success
<details>
...
INFORMATION (FluentJavaSettings): Option, boolean, sdk-integration : null
INFORMATION (FluentGen): Map code model to client model
INFORMATION (FluentMapper): Add Inner to response types: [IotSensorsList, SecurityAssessmentMetadata, TopologyResource, Setting, WorkspaceSetting, AutomationValidationStatus, AdaptiveNetworkHardening, Compliance, IoTSecurityAggregatedRecommendation, SecuritySolutionsReferenceDataList, DiscoveredSecuritySolution, DeviceSecurityGroup, IotAlertTypeList, IotAlert, RegulatoryComplianceAssessment, RulesResults, IotRecommendationTypeList, SecureScoreControlDefinitionItem, SecuritySolution, RuleResults, OnPremiseIotSensorsList, AllowedConnectionsResource, IoTSecurityAggregatedAlert, SecuritySubAssessment, Device, IotAlertModel, ServerVulnerabilityAssessmentsList, ScanResults, IotSensorsModel, IotDefenderSettingsList, Operation, ServerVulnerabilityAssessment, SecurityAssessment, IotSitesModel, IotRecommendation, Alert, IotAlertType, ScanResult, SecurityTask, RegulatoryComplianceStandard, AdaptiveApplicationControlGroup, JitNetworkAccessRequest, Scans, IoTSecuritySolutionAnalyticsModel, Pricing, IoTSecuritySolutionAnalyticsModelList, IotSitesList, OnPremiseIotSensor, PackageDownloads, AdvancedThreatProtectionSetting, IotDefenderSettingsModel, RegulatoryComplianceControl, ConnectorSetting, InformationProtectionPolicy, AutoProvisioningSetting, IotRecommendationModel, JitNetworkAccessPolicy, ComplianceResult, IoTSecuritySolutionModel, SecurityContact, ExternalSecuritySolution, Automation, AlertsSuppressionRule, Scan, SecureScoreControlDetails, AdaptiveApplicationControlGroups, PricingList, IotRecommendationType, SecureScoreItem, AscLocation]
...
FATAL: [object Object]
(node:24851) UnhandledPromiseRejectionWarning: Error: Plugin model-validator reported failure.
...
(node:24851) UnhandledPromiseRejectionWarning: Unhandled promise rejection. This error originated either by throwing inside of an async function without a catch block, or by rejecting a promise which was not handled with .catch(). To terminate the node process on unhandled promise rejection, use the CLI flag `--unhandled-rejections=strict` (see https://nodejs.org/api/cli.html#cli_unhandled_rejections_mode). (rejection id: 60)
(node:24851) [DEP0018] DeprecationWarning: Unhandled promise rejections are deprecated. In the future, promise rejections that are not handled will terminate the Node.js process with a non-zero exit code.
...
[INFO] Finished at: 2021-02-16T19:15:34Z
[INFO] ------------------------------------------------------------------------
...
[INFO] Finished at: 2021-02-16T19:16:03Z
[INFO] ------------------------------------------------------------------------
