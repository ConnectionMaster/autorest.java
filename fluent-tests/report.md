# Java Codegen Report
Generated at 2021-05-28T20:22:24.592273
## Success
<details>
...
[INFO] Finished at: 2021-05-28T19:46:58Z
[INFO] ------------------------------------------------------------------------
...
[INFO] Finished at: 2021-05-28T19:55:13Z
[INFO] ------------------------------------------------------------------------
...
INFORMATION (FluentJavaSettings): Option, boolean, sdk-integration : null
INFORMATION (FluentGen): Map code model to client model
INFORMATION (FluentMapper): Add Inner to response types: [ConnectionStrings, IoTSecuritySolutionAnalyticsModel, RegulatoryComplianceAssessment, RegulatoryComplianceStandard, AdvancedThreatProtectionSetting, IotDefenderSettingsModel, Pricing, IotSitesList, AdaptiveApplicationControlGroup, ServerVulnerabilityAssessmentsList, SecurityAssessmentMetadata, JitNetworkAccessRequest, PackageDownloads, SecureScoreControlDetails, AdaptiveNetworkHardening, Scans, SecuritySubAssessment, PricingList, OnPremiseIotSensorsList, SecuritySolutionsReferenceDataList, IotSensorsModel, IotAlertModel, RulesResults, IotAlertType, Operation, IotRecommendationModel, ExternalSecuritySolution, Device, ConnectorSetting, ScanResult, WorkspaceSetting, AdaptiveApplicationControlGroups, AscLocation, IotSitesModel, IotRecommendationType, Scan, ScanResults, AutoProvisioningSetting, Automation, SecurityContact, IotSensorsList, Compliance, Setting, IotRecommendation, Alert, IngestionSetting, DiscoveredSecuritySolution, RuleResults, IoTSecuritySolutionModel, SecureScoreControlDefinitionItem, SecurityTask, RegulatoryComplianceControl, SecuritySolution, ComplianceResult, IotAlertTypeList, AlertsSuppressionRule, TopologyResource, IotDefenderSettingsList, IoTSecurityAggregatedAlert, IngestionSettingToken, IotAlert, AllowedConnectionsResource, IotRecommendationTypeList, InformationProtectionPolicy, SecurityAssessment, JitNetworkAccessPolicy, Software, ServerVulnerabilityAssessment, AutomationValidationStatus, SecureScoreItem, DeviceSecurityGroup, IoTSecurityAggregatedRecommendation, IoTSecuritySolutionAnalyticsModelList, OnPremiseIotSensor]
...
INFORMATION (FluentJavaSettings): Option, boolean, sdk-integration : null
INFORMATION (FluentGen): Map code model to client model
INFORMATION (FluentMapper): Add Inner to response types: [Liveness, Connection, ClientGroupMembersCount, ClientGroupMember, MachinesSummary, Machine, Process, MachineGroup, Port, ClientGroup, MapResponse]
...
[INFO] Finished at: 2021-05-28T20:04:45Z
[INFO] ------------------------------------------------------------------------
